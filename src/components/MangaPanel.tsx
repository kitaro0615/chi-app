...
export function MangaPanel({ panel }: MangaPanelProps) {
  ...
  return (
    <figure className="overflow-hidden rounded-xl border-2 border-slate-200 bg-white shadow-sm">
      ...
      {panel.caption && (
        <figcaption className="border-t border-slate-100 px-4 py-3 text-sm leading-relaxed text-slate-700">
          {panel.caption}
        </figcaption>
      )}
    </figure>
